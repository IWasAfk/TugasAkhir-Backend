          ...
          children: [
            ...
            Row(
              children: [
                ...
                Expanded(
                  flex: 1,
                  child: buildTextField('', beratController1, hint: 'Gram', onChanged: (_) => updateHargaOtomatis(beratController1, hargaController1, jenisSampah1),),
                ),
                SizedBox(width: 8),
                Expanded(
                  flex: 1,
            ...
            Row(
              children: [
                ...
                Expanded(
                  flex: 1,
                  child: buildTextField('', beratController2, hint: 'Gram', onChanged: (_) => updateHargaOtomatis(beratController2, hargaController2, jenisSampah2),),
                ),
                SizedBox(width: 8),
                Expanded(
                  flex: 1,
            ...
            Row(
              children: [
                ...
                Expanded(
                  flex: 1,
                  child: buildTextField('', beratController3, hint: 'Gram', onChanged: (_) => updateHargaOtomatis(beratController3, hargaController3, jenisSampah3),),
                ),
                SizedBox(width: 8),
                Expanded(
                  flex: 1,
            ...
            Row(
              children: [
                ...
                Expanded(
                  flex: 1,
                  child: buildTextField('', beratController4, hint: 'Gram', onChanged: (_) => updateHargaOtomatis(beratController4, hargaController4, jenisSampah4),),
                ),
                SizedBox(width: 8),
                Expanded(
                  flex: 1,
            ...
            Row(
              children: [
                ...
                Expanded(
                  flex: 1,
                  child: buildTextField('', beratController5, hint: 'Gram', onChanged: (_) => updateHargaOtomatis(beratController5, hargaController5, jenisSampah5),),
                ),
                SizedBox(width: 8),
                Expanded(
                  flex: 1,
            ...
            Row(
              children: [
                ...
                Expanded(
                  flex: 1,
                  child: buildTextField('', beratController6, hint: 'Gram', onChanged: (_) => updateHargaOtomatis(beratController6, hargaController6, jenisSampah6),),
                ),
                SizedBox(width: 8),
                Expanded(
                  flex: 1,
            ...
            Row(
              children: [
                ...
                Expanded(
                  flex: 1,
                  child: buildTextField('', beratController7, hint: 'Gram', onChanged: (_) => updateHargaOtomatis(beratController7, hargaController7, jenisSampah7),),
                ),
                SizedBox(width: 8),
                Expanded(
                  flex: 1,
            ...
            Row(
              children: [
                ...
                Expanded(
                  flex: 1,
                  child: buildTextField('', beratController8, hint: 'Gram', onChanged: (_) => updateHargaOtomatis(beratController8, hargaController8, jenisSampah8),),
                ),
                SizedBox(width: 8),
                Expanded(
                  flex: 1,
